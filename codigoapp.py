...
MARCADORES_CONDICIONALES = {
    ...
    "LEGA_STATUS": {
        ...
        "en curso":{"start": "{INICIO_LEGA_EN_CURSO}", "end": "{FIN_LEGA_EN_CURSO}"},
    },
    ...
    if st.button("GENERAR INFORME", use_container_width=True, type="primary"):
        try:
            ...
            user_data = {
                ...
                'FECHA_ULTIMA_LEGA_PDEG': st.session_state.get('key_hist_lega_fecha_u', ''),
                'VENCIMIENTO_ULTIMA_LEGA_PDEG': st.session_state.get('key_hist_lega_vto_u', ''),
                'EXPEDIENTE_ULTIMA_LEGA_PDEG': st.session_state.get('key_hist_lega_exp_u', ''),
